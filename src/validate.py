...
class CompletionEvaluator:
    ...
    def test(self,args,is_val=True, edge_index_valid=None, edge_type_valid = None, filterr = False, logger=None):
        ...
        all_index = list(range(total_entity_num))
         # 指定文件路径
        file_path = '/home/wsco/DBB/JMAC-mgnn-0516/JMAC-master/datasetdbp5l/case study/entity_rankings.csv'
        ...
        with open(file_path, 'a', newline='') as file:
            ...
            writer.writerow(['Head Entity', 'Relation', 'Tail Entity', 'Rank'])  # 写入列标题
            ...
            for kg_batch_each in kg_batch_generator:
                ...
                for j in range(kg_batch_each.shape[0]):
                    ...
                    ranks.append(rank + 1)
                    # 将每个尾实体的排名写入文件
                    writer.writerow([h_batch[j], r_batch[j], t_batch[j], rank + 1])
